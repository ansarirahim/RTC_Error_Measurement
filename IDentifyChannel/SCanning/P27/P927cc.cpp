...
#include <pthread.h>
#include <unistd.h>
#define PATH_COUNTS "/root/160718/countsP927"
#define PATH_BIN "/root/160718/IDentifyChannel/SCanning/P27/P927c.bin"
#define PRU_NUM 0
#include <fstream>  
#include <iostream>
using std::cout;
...
if((odd==0)||(even==0))
cout<<"\n NO PULSE/HIGH-LOW TRANSITION FOUND"<<endl;//return -1;
else
cout <<"\n PULSE TRAIN FOUND..."<<endl;//return 1;
